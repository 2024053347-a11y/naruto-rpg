export const DEFAULT_MAIN_PRESET = {
  ...
  entries: [
    ...
    },
    {
      ...
      content: "<|no-trans|>- 根据<格式要求>，将以下顺序作为输出的格式：\n<thinking>\n${回映内容}\n[回映结束]\n</thinking>\n\n<status_query />\n\n【注意：这里必须输出详细、富有沉浸感的剧情正文(maintxt)，严格遵循字数要求，这是必须履行的核心任务！】\n${maintxt powered by <文风指导>}\n\n「${action}」\n\n<variable_thinking>\n【变量自检协议】\n1. 人物与关系：本回合涉及的NPC？互动性质？感情/信任/尊重变化量及理由？无互动则写简要原因\n2. 技能变动：本回合是否学习/创造/练习/升级了忍术/体术/幻术/血继/天赋？列出技能名和操作\n3. 物品与装备：本回合是否获得/消耗/使用/丢弃了物品/武器/防具/忍具/金钱？列出物品名和数量变化\n4. 任务与历练：本回合是否推进了任务？是否应有exp变化？列出任务id/状态和exp变化理由\n5. 地图与探索：本回合是否移动到了新场景？发现了新地标/新区域？列出新位置\n6. 状态与位置：时间流逝？查克拉/体力/精神/意志力消耗或恢复？异常状态变化？\n7. 战斗状态：是否触发/进行/结束了战斗？（仅战斗回合）\n结论：我将输出以下变量：[逐条列出]（无变动则写本回合无变量变动）\n</variable_thinking>\n\n<variable>\n${Handmade by KishimoMasashi}\n</variable>\n\n<memory>\n${Handmade by KishimoMasashi}\n</memory>\n\n<relationship>\n${Handmade by KishimoMasashi}\n</relationship>\n\n<mission>\n${Handmade by KishimoMasashi}\n</mission>\n\n[回映开始]"
    },
    {
